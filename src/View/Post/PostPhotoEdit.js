...
export default class PostPhoto extends Component {
    constructor(props){
        ...
        this.state = {
            ...
            valueCategoryPhoto1: this.props.navigation.state.params.valueCategoryPhotoEdit,
            contentPhoto: this.props.navigation.state.params.contentPhotoEdit,
            valuePlacePhoto:this.props.navigation.state.params.valuePlacePhotoEdit,
            datetimePhoto: this.props.navigation.state.params.datetimePhotoEdit,
            datetimePhoto1: this.props.navigation.state.params.datetimePhotoEdit1,
            costPhoto: this.props.navigation.state.params.costPhotoEdit,
            labelErrorAddress: false, labelErrorCatg: false, labelErrorCost: false, labelErrorTime: false,
           labelErrorLessTime: false
        }
