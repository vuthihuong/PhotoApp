...
export default class ChatPersonReq extends Component {
    constructor(props) {
        super(props)
        this.state = {
            mess: '',
    ...
    render() {
        return (
            <View style={{ flex: 1, backgroundColor: 'white' }}>
                ...
                <View style={stylesChatPersonReq.container}>
                    <ScrollView>
                        <ListView
                    ...
                    <View>
                        <View style={stylesChatPersonReq.txt}>
...
stylesChatPersonReq = StyleSheet.create({
    container: {
